...
"  </div>", "text/html");
    ...
    public static void SendMailOferta(String user, String as, String mensaje){
        String servidorSMTP = "smtp.gmail.com";
        String puerto = "587";
        String usuario = "terpel360@gmail.com";
        String password = "jrsoft2016";
        String asunto = as;
 ...
 System.out.println("0 ");
        try {
         ...
         MimeMultipart alternative = new MimeMultipart("alternative");
         MimeMessage message = new MimeMessage(session);
         message.setFrom(new InternetAddress("Terpel Colombia <terpel360@gmail.com>"));
         MimeBodyPart html = new MimeBodyPart();
...
" </div>" , "text/html");
 ...
 System.out.println("3 ");
    ...
    public static void SendMailVehiculoGeneradores(List<String> users, Servicio servicio){
        String servidorSMTP = "smtp.gmail.com";
        String puerto = "587";
        String usuario = "terpel360@gmail.com";
        String password = "jrsoft2016";
        String asunto = "Ingreso de nuevo vehiculo.";
 System.out.println("0 ");
        Properties props = new Properties();
...
"     </div>    \n" +
"     <div style=\"background-color:#F0F0F0;padding:10px;\">\n" +
"       <h2 style=\"text-align:center;\">INGRESO DE NUEVO VEHICULO</h2>\n" +
"       <center><img width=\"200px\" src=\""+servicio.getUrl_transportadora()+"\"/></center>\n" +
"       <p style=\"padding:10px;\">\n" +
"           La empresa <b>"+servicio.getTransportadora()+"</b> ha ingresado un nuevo vehiculo, y espera su aprovación.\n" +
"       </p>\n" +
"       <table style=\"width:100%;margin-top: 15px; border: #BDBDBD solid 1px;\" rules=\"all\" >\n" +
"           <tr>\n" +
"               <th colspan=\"2\" style=\"background-color: #E8E8E8;text-align: center;\">DATOS DEL VEHICULO</th>\n" +
...
"       </table>\n" +
"       <div style='border-top: 1px solid #E0E0E0;padding:25px;'>\n" +
"           <center><a style=\"background-color: black; color:white; padding: 7px;\" href=\"http://logycus360.com/forward?url_forward=/empresas/vehiculos.jsp\"><b>MAS INFORMACIÓN AQUI</b></a></center>\n" +
"       </div>\n" +
"   <div style='border-top: 1px solid #E0E0E0;padding:25px;'>\n" +
"    <center>Por favor no responder a este email.</center>\n" +
"    <center>Los correos electrónicos enviados a esta dirección no serán contestados.</center>\n" +
...
" </div>" , "text/html");
 ...
 System.out.println("3 ");
    ...
    public static void SendMailConductoresGeneradores(List<String> users, Servicio servicio){
        String servidorSMTP = "smtp.gmail.com";
        String puerto = "587";
        String usuario = "terpel360@gmail.com";
        String password = "jrsoft2016";
        String asunto = "Ingreso de nuevo conductor.";
 System.out.println("0 ");
        Properties props = new Properties();
...
"     </div>    \n" +
"     <div style=\"background-color:#F0F0F0;padding:10px;\">\n" +
"       <h2 style=\"text-align:center;\">INGRESO DE NUEVO CONDUCTOR</h2>\n" +
"       <center><img width=\"200px\" src=\""+servicio.getUrl_transportadora()+"\"/></center>\n" +
"       <p style=\"padding:10px;\">\n" +
"           La empresa <b>"+servicio.getTransportadora()+"</b> ha ingresado un nuevo conductor, y espera su aprovación.\n" +
"       </p>\n" +
"       <table style=\"width:100%;margin-top: 15px; border: #BDBDBD solid 1px;\" rules=\"all\" >\n" +
"           <tr>\n" +
"               <th colspan=\"2\" style=\"background-color: #E8E8E8;text-align: center;\">DATOS DEL CONDUCTOR</th>\n" +
...
" </div>" , "text/html");
 ...
 System.out.println("3 ");
    ...
    public static void SendMailVehiculoGeneradoresAprov(List<String> users, Servicio servicio){
        String servidorSMTP = "smtp.gmail.com";
        String puerto = "587";
        String usuario = "terpel360@gmail.com";
        String password = "jrsoft2016";
        String asunto = "Aprovacion de vehiculo.";
 System.out.println("0 ");
        Properties props = new Properties();
...
"     </div>    \n" +
"     <div style=\"background-color:#F0F0F0;padding:10px;\">\n" +
"       <h2 style=\"text-align:center;\">APROVACIÓN DE VEHICULO</h2>\n" +
"       <center><img width=\"200px\" src=\""+servicio.getUrl_transportadora()+"\"/></center>\n" +
"       <p style=\"padding:10px;\">\n" +
"           EL VEHICULO CON LA SIGUIENTE INFORMACION HA SIDO APROVADO.\n" +
"       </p>\n" +
"       <table style=\"width:100%;margin-top: 15px; border: #BDBDBD solid 1px;\" rules=\"all\" >\n" +
"           <tr>\n" +
"               <th colspan=\"2\" style=\"background-color: #E8E8E8;text-align: center;\">DATOS DEL VEHICULO</th>\n" +
...
" </div>" , "text/html");
 ...
 System.out.println("3 ");
    ...
    public static void SendMailConductoresGeneradoresAprov(List<String> users, Servicio servicio){
        String servidorSMTP = "smtp.gmail.com";
        String puerto = "587";
        String usuario = "terpel360@gmail.com";
        String password = "jrsoft2016";
        String asunto = "Aprovacion de conductor.";
 System.out.println("0 ");
        Properties props = new Properties();
...
"       <center><img width=\"200px\" src=\""+servicio.getUrl_transportadora()+"\"/></center>\n" +
"       <p style=\"padding:10px;\">\n" +
"           EL CONDUCTOR CON LA SIGUIENTE INFORMACION HA SIDO APROVADO POR TERPEL.\n" +
"       </p>\n" +
"       <table style=\"width:100%;margin-top: 15px; border: #BDBDBD solid 1px;\" rules=\"all\" >\n" +
"           <tr>\n" +
"               <th colspan=\"2\" style=\"background-color: #E8E8E8;text-align: center;\">DATOS DEL CONDUCTOR</th>\n" +
