                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default tabs">
                                <ul class="nav nav-tabs nav-justified">
                                    ...
                                    <li><a href="../#tab2" data-toggle="tab" ng-click="ctrl.getData(1)">Zonas</a></li>
                                    <li><a href="../#tab3" data-toggle="tab" ng-click="ctrl.getData(1)">Bahias</a></li>
                                </ul>
                                                                    ...
                                                                    <div class="form-group" >
                                                                        ...
                                                                        <div class="col-md-9">                                            
                                                                            <div class="input-group" style="z-index: 9999;">
                                                                                ...
                                                                                <select class="form-control select" ng-model="ctrl.punto.select" ng-change="ctrl.selectPuntoDet(ctrl.punto.select)"
                                                                                        ng-options="punto.id as punto.desc for punto in ctrl.puntos" >
                                                                                    <option value="">Seleccione punto</option>
                                                                                    <option value="0">Crear punto</option>
                                                                                </select>
                                                                            </div>                                            
                                                                        </div>
                                                                    </div>
