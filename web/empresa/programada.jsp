                            ...
                            <div class="panel-body">                                
                                <div class="list-group" style="height: 300px; overflow: scroll; overflow-x: hidden;">
                                    <a href="#" class="list-group-item" ng-repeat="spot in dias.spots">
                                        <p class="list-group-item-text"><b>Punto de origen:</b> {{spot.inicio.desc}}</p>
                                        <p class="list-group-item-text"><b>Punto de destino:</b> {{spot.fin.desc}}</p>
                                        <p class="list-group-item-text"><b>Tipo de cargue:</b> {{spot.carga.desc}}</p>
                                        ...
                                        <p style="text-align: right;"><button type="button" class="btn btn-sm btn-success">Editar</button></p>
                                    </a>
                                </div>
                            </div>
                        </div>
