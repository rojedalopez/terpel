...
<head>
    ...
    <script>
        var CrearServicio, VerEnMapa, CrearServicioMult;
        $(document).ready(function(){
            CrearServicio = $("#CrearServicio");
            CrearServicioMult = $("#CrearServicioMult");
            VerEnMapa = $("#VerEnMapa");
        });
    </script>
...
<body ng-app="myApp" class="ng-cloak" >
    ...
    <div style="height: 600px;" ng-controller="ServEnturneController as ctrl">
                        ...
                        <table id="vehiculos" datatable="ng" dt-options="ctrl.dtOptions" class="table table-striped table-bordered dt-responsive nowrap compact" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                <tr ng-repeat="vehiculo in ctrl.vehiculos">
                                    ...
                                    <td><input type="checkbox" class="form-control" ng-model="vehiculo.enviar" ng-change="ctrl.addPlaca(vehiculo)"/> </td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="modal-body">
                    <form name="envioAsign">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" ng-model="ctrl.servicio.cargue" ng-options="cargue.id as cargue.desc for cargue in ctrl.cargues" ng-change="ctrl.asignNombre(ctrl.servicio.cargue)">
        ...
        <div id="CrearServicioMult" class="modal fade" role="dialog">
            <div class="modal-dialog">
              ...
              <div class="modal-content">
                <div class="modal-header">
                  <button type="button" class="close" data-dismiss="modal">&times;</button>
                  <h4 class="modal-title">Asignacion Multiple</h4>
                </div>
                <div class="modal-body">
                    <form name="envioAsignMult">
                        <div class="form-group">
                            <label>Punto de origen</label>
                            <select class="form-control" ng-model="ctrl.servicio.origen" ng-options="punto.id as punto.desc for punto in ctrl.puntos" ng-change="ctrl.selectOrigen(ctrl.servicio.origen)" >
                                <option value="">Seleccione Origen</option>
