            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="login-panel panel panel-default">                  
                    ...
                    <div class="panel-body" >
                        ...
                        <div class="col-lg-6" style="cursor: pointer;" onclick="location.href='transporter/';">
                            <div class="panel panel-primary text-center no-boder">
                                ...
                                <div class="panel-footer">
                                    <span class="panel-eyecandy-title">Ingresa como transportadora
                                    </span>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6" style="cursor: pointer;" onclick="location.href='empresa/';">
                            <div class="panel panel-primary text-center no-boder">
                                ...
                                <div class="panel-footer">
                                    <span class="panel-eyecandy-title">Ingresa como usuario de Terpel
                                    </span>
                                </div>
                            </div> 
                        </div>
